...
constructor(canvasWidth = 900, canvasHeight = 600){ // permet de modifier apres si on souhaite la taille du canvas pour Game2
...
this.score = 0;
clearTimeout(this.timeOut); // evite d'avoir plusieurs refresh canvas
this.delay = 100;
this.refreshCanvas();
}
refreshCanvas(){   
...
else
{
    ...
    this.timeOut = setTimeout(this.refreshCanvas.bind(this), this.delay); // bind ici permet de bind le this du jeu et non de window
}
